...
<div class="md-form mt-0">
  <form action="/QuanLyBanLapTop/admin/addTaiKhoan" method="GET" >
    ...
    <thead>
      <tr>
        <th style="text-align: center;font-style: bold; padding: 5px;">Mã Tài Khoản</th>
    ...
    <c:forEach var="item" items="${listtk}">
      <tr>
          <td style="text-align: center;">${item.ma_tai_khoan}</td>
          <td style="text-align: center;">${item.ten_dang_nhap}</td>
          <td style="text-align: center;">${item.quyen_truy_cap}</td>
